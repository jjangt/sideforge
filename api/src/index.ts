...
{"score":0-100,"summary":"한줄요약","strengths":["강점1","강점2","강점3"],"weaknesses":["약점1","약점2","약점3"],"actions":["구체적 개선액션1","개선액션2","개선액션3"],"contentIdeas":["추천콘텐츠1","추천콘텐츠2","추천콘텐츠3"],"benchmarks":[{"name":"실제 채널명","reason":"당신의 채널은 [약점]. '[채널명]' 채널과 같이 [구체적 빈도/방법]을 지켜야 [기대효과]를 얻을 수 있으며, [추가 조언]을 참고하세요.","url":"youtube.com/@핸들"},{"name":"두번째","reason":"근거","url":"youtube.com/@핸들"},{"name":"세번째","reason":"근거","url":"youtube.com/@핸들"}]}
